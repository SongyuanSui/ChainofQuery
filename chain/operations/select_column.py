...
import re
import numpy as np
from chain.utils.helper import table2df, NoIndent, MyEncoder
from chain.utils.const import DATASET
from chain.third_party.select_column_row_prompts.select_column_row_prompts import select_column_tabfact, select_column_wiki, select_column_fetaqa
...
def select_column_func(sample, table_info, llm, llm_options, debug=False, num_rows=100):
    ...
    prompt = "" + eval(f"select_column_{DATASET}").rstrip() + "\n\n" 
