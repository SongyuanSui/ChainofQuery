...
from chain.third_party.select_column_row_prompts.select_column_row_prompts import select_row_tabfact, select_row_fetaqa, select_row_wiki
...
def select_row_func(sample, table_info, llm, llm_options=None, debug=False):
    ...
    prompt = "" + eval(f"select_row_{DATASET}").rstrip() + "\n\n"
