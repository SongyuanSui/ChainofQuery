...
add_column_fetaqa = """To answer the question, we can first use f_add_column() to add more columns to the table.
...
add_column_wiki = """To answer the question, we can first use f_add_column() to add more columns to the table.
...
add_column_tabfact = """To tell the statement is true or false, we can first use f_add_column() to add more columns to the table.
...
def add_column_func(
    ...
    prompt = "" + eval(f"add_column_{DATASET}").rstrip() + "\n\n"
