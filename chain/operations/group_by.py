...
group_column_fetaqa = """To answer the question, we can first use f_group() to group the values in a column.
...
group_column_wiki = """To answer the question, we can first use f_group() to group the values in a column.
...
group_column_tabfact = """To tell the statement is true or false, we can first use f_group() to group the values in a column.
...
def group_column_func(
    ...
    prompt = "" + eval(f"group_column_{DATASET}").rstrip() + "\n\n"  
