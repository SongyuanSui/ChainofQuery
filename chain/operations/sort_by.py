...
sort_column_wiki = """To answer the question, we can first use f_sort() to sort the values in a column to get the order of the items. The order can be "large to small" or "small to large".
...
sort_column_fetaqa = """To answer the question, we can first use f_sort() to sort the values in a column to get the order of the items. The order can be "large to small" or "small to large".
...
sort_column_tabfact = """To tell the statement is true or false, we can first use f_sort() to sort the values in a column to get the order of the items. The order can be "large to small" or "small to large".
...
def sort_column_func(
    ...
    prompt = "" + eval(f"sort_column_{DATASET}").rstrip() + "\n\n"
